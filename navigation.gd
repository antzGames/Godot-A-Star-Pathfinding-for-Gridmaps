extends Node
# By Antz: Tutorial at: https://youtu.be/t4-R5tmFakw

# A* Pathfinding for GridMaps
...
# Call when you need to find the path between two actor positions.
...
func do_debug_path(grid_map_in: GridMap, grid_map_cell_size: int, start_pos, target_pos):
	...
	DebugDraw2D.set_text("0. ESC key exits demo")
